...
/*   Updated: 2021/02/25 13:02:35 by rarias-p         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

void	load_images(t_data *data, int width, int height)
{
	...
	&width, &height);
	data->n_text5 = mlx_xpm_file_to_image(data->mlx_ptr, data->text_sp2,
	&width, &height);
	...
	&data->ls, &data->endian);
	data->n_info5 = (int *)mlx_get_data_addr(data->n_text5, &data->bpp,
	&data->ls, &data->endian);
}
